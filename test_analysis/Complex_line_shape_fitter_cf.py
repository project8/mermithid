...
class ComplexLineShapeTests(unittest.TestCase):
    ...
    def test_complex_lineshape(self):
        ...
        data_path = '/host/central_frequency_data_dict_with_start_freqs_and_min_rf_roi.json'
...
#        factor_array = [0.4, 0.45, 0.5, 0.55, 0.6, 0.61, 0.62, 0.63, 0.64, 0.65, 0.66, 0.67, 0.68, 0.69, 0.7, 0.75, 0.8]
        ...
        for max_snr in [max_snr_array[0]]:
            complexLineShape_config['path_to_ins_resolution_data_txt'] = '/host/October_FTC_resolution/all_res_cf{}.txt'.format(max_snr)
            ...
            plt.savefig('/host/plots/fit_CF_with_simulated_resolution_factor_0.4626_max_snr_{}.png'.format(max_snr))
            output_dict['max_snr {}'.format(max_snr)] = results
        np.save('/host/results_cf_max_snr_scan_factor_0.4626.npy', output_dict)
