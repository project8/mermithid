...
#                 if i == 10:
        complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/March_FTC_resolution/all_res_cf18.000.txt'
...
#        complexLineShape_config['fixed_parameter_values'] = fixed_para_values
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_18.000_factor_0.4955_new_gas_fraction.png')# March_FTC
        output_dict['max snr 18.000'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_18.000_factor_0.4955_new_gas_fraction.npy', output_dict)
