...
class ComplexLineShapeTests(unittest.TestCase):
    ...
    def test_complex_lineshape(self):
        ...
        complexLineShape_config = {
            ...
            'fixed_parameter_values': [1.0, 1.0, (0.003+0.007)/2, (0.013+0.031)/2],   #[1.0, 1.0, 0.087, 0.884, 0.006], [1.0, 1.0, 0.886, 0.02, 0.06]   
            # This is an important parameter which determines how finely resolved
            # the scatter calculations are. 10000 seems to produce a stable fit, with minimal slowdown
            'num_points_in_std_array': 6000,
            'RF_ROI_MIN': 25890625000.0, #1439.7e6 + 24.5e9 -50e6, #25890625000.0, #25850000000.0
...
#        factor_array = [0.4, 0.45, 0.5, 0.55, 0.6, 0.61, 0.62, 0.63, 0.64, 0.65, 0.66, 0.67, 0.68, 0.69, 0.7, 0.75, 0.8]
        factor = 0.4955
        #fixed_para_values = [1.0, 0.884, 0.087, 0.006]
        #for max_snr in [max_snr_array[36]]:
        max_snr = 14.643
        complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/averaged_resolutions/averaged_shallow_trap_resolution.txt'
