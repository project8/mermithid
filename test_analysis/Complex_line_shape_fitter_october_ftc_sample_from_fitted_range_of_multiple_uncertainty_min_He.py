...
#         data['StartFrequency'] = np.array(start_freqs_vs_fss['0.0']) - 1.40812680e+09 + 50e6
        ...
        path_to_fit_result = '/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_factor_0_new_gas_fraction_min_He.npy'
...
#            complexLineShape_config['path_to_ins_resolution_data_txt'] = '/host/October_FTC_resolution/all_res_cf14.300.txt'
    ...
    #        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
            ...
            plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_with_new_gas_fraction_factor_0_sample_from_fitted_range_of_multiple_uncertainties_min_He_q_{}.png'.format(q))# March_FTC
            output_dict['october max snr 14.300 with q {}'.format(q)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_factor_0_new_gas_fraction_sample_from_fitted_range_of_multiple_uncertainties_min_He.npy', output_dict)
#             time.sleep(600)
