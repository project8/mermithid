...
sens_config_dict = {
    # required
    "config_file_path": "/termite/sensitivity_config_files/Config_LFA_Experiment_500MHz.cfg", #"/termite/sensitivity_config_files/Config_LFA_Experiment.cfg",
    "plot_path": "./lfa_Neutrino2024_plot_modified_for_DNP_sensitivity_vs_exposure.pdf",
    "exposure_axis": True,
    # optional
    "figsize": (10,6),
    "fontsize": 15,
    ...
    "main_curve_upper_label":  r"Phase III - 500 MHz",
    ...
    "comparison_config_file_path": ["/termite/sensitivity_config_files/Config_LFA_Experiment_1GHz.cfg",
                                    "/termite/sensitivity_config_files/Config_atomic_150MHz_minpitch_87deg.cfg"], 
    "comparison_curve_label": [r"Phase III - 1 GHz", r"Phase IV scenario - 150 MHz"], 
    "comparison_curve_colors": ["dodgerblue", "black"],
