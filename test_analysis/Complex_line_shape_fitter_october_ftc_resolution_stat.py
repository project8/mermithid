...
#        for directory in [directories[0]]:
        for i in range(100):
            complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/stat-varying-resolutions/october/res_stat_{}.txt'.format(i)
    ...
    #        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
            ...
            plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_with_new_gas_fraction_res_stat_{}.png'.format(i))# March_FTC
            output_dict['october max snr 14.300 res stat {}'.format(i)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_factor_0.4955_new_gas_fraction_res_stat.npy', output_dict)
#             time.sleep(600)
