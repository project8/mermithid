...
#        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_max_snr_14.300_factor_0_with_new_gas_fraction_inflated_error_fit_c.png')# March_FTC
        output_dict['october max snr 14.300'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_factor_0_new_gas_fraction_inflated_error_fit_c.npy', output_dict)
#             time.sleep(600)
