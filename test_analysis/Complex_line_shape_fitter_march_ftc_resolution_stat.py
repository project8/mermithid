...
#        for f in [0.4626]:
        ...
        for i in range(100):
            ...
            complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/stat-varying-resolutions/march/res_stat_{}.txt'.format(i)
            ...
            plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_15.200_factor_0.4955_new_gas_fraction_res_stat_{}.png'.format(i))# March_FTC
            output_dict['max snr 15.200 res stat {}'.format(i)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_15.200_factor_0.4955_res_stat_new_gas_fraction.npy'.format(f), output_dict)
