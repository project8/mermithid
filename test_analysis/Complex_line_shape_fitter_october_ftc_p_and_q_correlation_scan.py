...
#        for directory in [directories[0]]:
        for f in f_array: 
            for i in range(11):
                complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/res_stat_October_ftc/res_stat_{}.txt'.format(i)
                if i == 10:
        ...
        #        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
                ...
                plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_p_q_correlation_scan_new_gas_fraction_factor_{}_res_{}_4000.png'.format(f, i))# March_FTC
                output_dict['october max snr 14.300 factor {} resolution {}'.format(f, i)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_p_q_correlation_scan_new_gas_fraction_4000.npy', output_dict)
#             time.sleep(600)
