...
#        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/single_deep_trap_3_fit_scaling_factor_new_gas_fraction_single_trap_res_Kr_paper_standard_candle_nonreversed_res.png')# March_FTC
        output_dict['trap 3 cf 15.5'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/single_deep_trap_3_fit_scaling_factor_new_gas_fraction_single_trap_res_Kr_paper_standard_candle_nonreversed_res.npy', output_dict)
#             time.sleep(600)
