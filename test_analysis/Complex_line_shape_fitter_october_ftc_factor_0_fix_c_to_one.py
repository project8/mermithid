...
class ComplexLineShapeTests(unittest.TestCase):
    ...
    def test_complex_lineshape(self):
        ...
        complexLineShape_config = {
            ...
            'fixed_parameter_values': [1.0, 1.0, 1.0, (0.233+0.913)/2, 0.674/2, (0.051+0.104)/2],   #[1.0, 1.0, 0.886, 0.02, 0.06]   
...
#        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_max_snr_14.300_factor_0_with_new_gas_fraction_inflated_error_fix_c_to_one.png')# March_FTC
        output_dict['october max snr 14.300'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_14.300_factor_0_new_gas_fraction_inflated_error_fix_c_to_one.npy', output_dict)
#             time.sleep(600)
