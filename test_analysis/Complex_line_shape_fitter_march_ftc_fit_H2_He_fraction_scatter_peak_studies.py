...
class ComplexLineShapeTests(unittest.TestCase):
    ...
    def test_complex_lineshape(self):
        ...
        complexLineShape_config = {
            ...
            'fixed_parameter_values': [1.0, 1.0, (0.003+0.007)/2, (0.004 + 0.009)/2],   #[1.0, 1.0, 0.886, 0.02, 0.06]   
...
#        complexLineShape_config['fixed_parameter_values'] = fixed_para_values
        ...
        complexLineShape.data = data_multi_track_events
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_15.200_factor_0.4955_new_gas_fraction_fit_H2_He_fraction_multi_track_events.png')# March_FTC
        output_dict['max snr 15.200'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_15.200_factor_0.4955_new_gas_fraction_fit_H2_He_fraction_multi_track_events.npy'.format(f), output_dict)
