...
#        complexLineShape_config['fixed_parameter_values'] = fixed_para_values
        ...
        plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_15.200_factor_0_new_gas_fraction_max_He.png')# March_FTC
        output_dict['max snr 15.200'] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_15.200_factor_0_new_gas_fraction_max_He.npy'.format(f), output_dict)
