...
#         data['StartFrequency'] = np.array(start_freqs_vs_fss['0.0']) - 1.40812680e+09 + 50e6
        ...
        f = 0.4955
        output_dict = {}
        path_to_sampling_resolutions = '/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_varied/'
        directories = os.listdir(path_to_sampling_resolutions)
        for directory in directories:
            complexLineShape_config['path_to_ins_resolution_data_txt'] =  path_to_sampling_resolutions + directory
        #         if i == 10:
...
#        complexLineShape_config['scatter_fractions_for_gases'] = [0.817, 0.07, 0.08]
            ...
            plt.savefig('/home/ys633/lineshape_fitting/plots/fit_October_FTC_max_snr_sampling_{}_with_new_gas_fraction.png'.format(directory))# March_FTC
            output_dict['{}'.format(directory)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/october_max_snr_sampling_factor_0.4955_new_gas_fraction.npy', output_dict)
#             time.sleep(600)
