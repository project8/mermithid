...
#        f = 0.4626
            for i in range(11):
                complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/res_stat_March_ftc/res_stat_{}.txt'.format(i)
                if i == 10:
                    complexLineShape_config['path_to_ins_resolution_data_txt'] = '/home/ys633/lineshape_fitting/mermithid_share/March_FTC_resolution/all_res_cf15.300.txt'
        ...
        #        complexLineShape_config['fixed_parameter_values'] = fixed_para_values
                ...
                plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_15.300_factor_{}_resolution_{}_new_gas_fraction_4000.png'.format(f, i))# March_FTC
                output_dict['max snr 15.300 factor {} resolution {}'.format(f, i)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/march_max_snr_15.300_p_q_correlation_scan_new_gas_fraction_4000.npy', output_dict)
