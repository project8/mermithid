...
#         data['StartFrequency'] = np.array(start_freqs_vs_fss['0.0']) - 1.40812680e+09 + 50e6
        ...
        path_to_fit_result = '/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_15.200_factor_0_new_gas_fraction_min_He.npy'
...
#        for f in [0.4626]:
    ...
    #        complexLineShape_config['fixed_parameter_values'] = fixed_para_values
            ...
            plt.savefig('/home/ys633/lineshape_fitting/plots/fit_March_FTC_with_max_snr_15.200_factor_0_new_gas_fraction_sampling_from_fitted_range_of_multiple_uncertainties_min_He_q_{}.png'.format(q))# March_FTC
            output_dict['max snr 15.200 q {}'.format(q)] = results
        np.save('/home/ys633/lineshape_fitting/mermithid_share/fit_March_FTC_max_snr_15.200_factor_0_new_gas_fraction_sampling_from_fitted_range_of_multiple_uncertainties_min_He.npy', output_dict)
