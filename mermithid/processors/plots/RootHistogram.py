'''
An extension of the Root-based histogram class to incorporate Root histogram
division.
Authors: M. Guigue, A. Ziegler
Date: 8/1/2019
'''
...
class RootHistogram(object):
    '''
    Create default ROOT histogram object with added Divide capability from ROOT.
