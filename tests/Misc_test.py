...
class MiscTest(unittest.TestCase):
    ...
    def test_SensitivityCurveProcessor(self):
        ...
        sens_config_dict = {
            # required
            "config_file_path": "/home/chrischtel/repos/scripts/rreimann/data/Sensitivity/Config_PhaseIII_FSCD_molecular_V_eff_2cm3.cfg",
            ...
            "comparison_config_file_path": "/home/chrischtel/repos/scripts/rreimann/data/Sensitivity/Config_PhaseIV_atomic_V_eff_5m3.cfg",
