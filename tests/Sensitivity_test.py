...
class SensitivityTest(unittest.TestCase):
    ...
    def test_SensitivityCurveProcessor(self):
        ...
        sens_config_dict = {
            ...
            "main_curve_upper_label": r"CRES with T$_2$, conservative",
            ...
            "comparison_curve_label": [r"CRES with T$_2$, reaching target", "CRES with T, conservative", "CRES with T, reaching target"],
