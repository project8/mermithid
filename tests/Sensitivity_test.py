...
class SensitivityTest(unittest.TestCase):
    ...
    def test_SensitivityCurveProcessor(self):
        ...
        sens_config_dict = {
            ...
            #"density_range": [1e8, 1e12],
            "main_curve_upper_label": r"Molecular"+"\n"+"Reaching target",
            "comparison_curve_label": ["Molecular (2 yrs)"+"\n"+"Conservative", "Atomic"+"\n"+r"(10 $\times$ 3 yrs)"+"\n"+"Conservative", r"Atomic"+"\n"+"Reaching target"],
            "goals": {"Phase III (0.2 eV)": 0.2, "Phase IV (0.04 eV)": 0.04},
            "comparison_curve": True,
            "comparison_config_file_path": ["/termite/sensitivity_config_files/Config_PhaseIII_325MHz_Experiment_conservative.cfg", "/termite/sensitivity_config_files/Config_atomic_325MHz_Experiment_conservative.cfg", "/termite/sensitivity_config_files/Config_atomic_325MHz_Experiment.cfg"],
            "comparison_label_y_position": [2, 0.105, 0.046],
            "comparison_label_x_position": [4.5e15, 2.2e16, 1e15],
            "sigmae_theta_r": 0.159,
            "lower_label_y_position": 0.17,
            "upper_label_y_position": 0.7,
            "label_x_position": 4e14, #0.02, #1e14,
            "goals_x_position": 2e12, #0.0002
            "plot_key_parameters": True
            }
        sens_curve = CavitySensitivityCurveProcessor("sensitivity_curve_processor")
